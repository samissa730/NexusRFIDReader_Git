...
echo ""
echo "With docker compose you get step-ca (8443) + EST proxy (9443)."
echo "  EST URL: https://localhost:9443/est  (bootstrap token: changeme)"
echo "  Run: python test_est_enrollment.py"
echo ""
echo "Without EST, use step CLI: GUIDE_INITIAL_TESTING_STEP_CA.md"
echo ""
