...
if [ ! -f "$ICON_PATH" ]; then
    echo -e "${YELLOW}⚠️  Warning: Icon not found at $ICON_PATH${NC}"
...
echo -e "   ${GREEN}✓${NC} Desktop entry content created"
...
echo -e "${YELLOW}🖥️  Step 3: Creating application menu entry...${NC}"
...
echo -e "   ${GREEN}✓${NC} Desktop entry created for application list: $desktop_applications_path"
...
echo -e "   ${GREEN}✓${NC} Startup entry created: $desktop_autostart_path"
