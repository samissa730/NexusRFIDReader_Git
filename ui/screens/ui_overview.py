...
"border-bottom: 2px solid #404040;")
    ...
    def retranslateUi(self, OverviewScreen):
        ...
        self.rfid_connection_status.setText(QCoreApplication.translate("OverviewScreen", u"Disconnected", None))
        ...
        self.gps_connection_status.setText(QCoreApplication.translate("OverviewScreen", u"Disconnected", None))
